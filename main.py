...
for link in event_links:
    try:
        ...
        event_image_link = soup.find('div', class_='event-hero').find('picture').find('img').get('src') if len(soup.find('div', class_='event-hero').find('picture').find('img').get('src')) < 256 else None
